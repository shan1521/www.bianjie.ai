    ...
    inland: {
        ...
        introContent: {
            ...
            description: [
                ...
                {paragraph:  IRITA HUB 已作为跨链服务枢纽上线，并为许多企业级应用提供服务，以实现传统金融系统、分布式金融区块链应用以及其他复杂商业系统间的可信互操作和数据共享。同时，IRITA HUB 围绕企业计算需求，对 ID 的管理、数据隐私保护等功能需求做出了更多支持。},
            ]
        },
        architectureContent: {
            title: 产品架构,
