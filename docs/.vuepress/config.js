module.exports = {
    ...
    head: [
        ...
        ['link', { name: 'keywords', content: '上海边界智能科技有限公司,上海边界智能,边界智能,边界科技,BIANJIE.AI,bianjie.ai,IRITA,irita,IRITA HUB,边界智能文昌链,边界区块链,边界智能区块链' }],
        ['link', { name: 'description', content: '上海边界智能专注于区块链、大数据相关产品技术研发、应用平台建设和解决方案咨询的高科技公司和国家高新技术企业。以区块链跨链、隐私计算及大数据分析技术创新为核心，自主研发了安全可控、符合国密标准、支持下一代分布式商业系统的企业级联盟链 IRITA产品系列。' }],
        ...
        ['meta', {property:'og:description',content:'上海边界智能专注于区块链、大数据相关产品技术研发、应用平台建设和解决方案咨询的高科技公司和国家高新技术企业。以区块链跨链、隐私计算及大数据分析技术创新为核心，自主研发了安全可控、符合国密标准、支持下一代分布式商业系统的企业级联盟链 IRITA产品系列。'}],
