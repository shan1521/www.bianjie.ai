...
export const message={
    ...
    "core":{
        "title":"核心技术",
        "txt":"运用人工智能+区块链技术，提供保护数据隐私、尊重数据所有权，并支持数据被智能算法安全分布式使用的技术和服务。区块链上的分布式AI技术演示"
    },
    "product":{
        "title":"产品中心",
        "txt":[
            ...
            },
            {
                ...
                "能实现链上链下通联、数据隐私保护和授权访问、无缝跨链资源调用和非侵入式审计。IRIS的目标是成为基于跨链技术的下一代公有链，为企业和个人提供高效、安全、经济的数据" +
                "交换和智能分析服务，是打造分布式商业协作基础设施。"
