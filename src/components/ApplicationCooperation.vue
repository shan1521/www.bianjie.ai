	...
	<div class="applications_content_container">
		...
		<div class="applications_text_content">
			...
			<div class="application_list_content">
				...
				<p>创新的链上链外互操作可以支持数据保持原有业务逻辑和存储安全不变，无需数据搬家，仅在不泄漏患者隐私的前提下根据授权交换必要的信息。联盟链中许可的业务参与方通过链下应用提供高效的 ToC 的服务，同时拥有链上注册身份，可以通过区块链达到保障业务数据在合规流转过程中的安全访问，实现全生命周期的可审计可追溯。</p>
