	...
	<div class="about_container_content">
		...
		<div class="about_text_container">
			<div class="about_text_content_wrap">
				...
				<p>公司拥有雄厚的人才实力，同时也是全球著名跨链项目 COSMOS / IRISnet 的技术开发者。创始团队来自于 IBM Watson 全球研究院、万向区块链、中国金融在线、火币研究院等，在区块链技术研发方面超过3年经验、企业运营中超过10年以上工作经验，对相关行业领域均有着深厚的理解。核心研发团队毕业于卡内基梅隆（CMU）、马里兰（UMCP）、清华、北大、复旦、交大、人大等全球一流学府，覆盖计算机工程、自动化、算法与软件开发等专业。</p>
			</div>
		</div>
		...
		data(){
			return{
				...
				listArray:[
					...
					{
						date:'2019 年 8 月',
						content:'边界智能为星康链提供区块链技术支持的「区块链电子处方共享平台」荣获2019中国优秀区块链解决方案'
					},
					{
						date:'2019 年 6 月',
