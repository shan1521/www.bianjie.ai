        ...
        "product": {
            ...
            "txt": [
                ...
                },
                {
                    ...
                    "txt": "基于Cosmos的开放网络。其底层技术包括Tendermint共识引擎，以太坊智能合约虚拟机（EVM）和跨区块链通讯协议（IBC）；其核心创新是一个基于智能合约的服务框架，" +
                    "能实现链上链下通联、数据隐私保护和授权访问、无缝跨链资源调用和非侵入式审计。<div>IRIS的目标是成为基于跨链技术的下一代开放网络，为企业和个人提供高效、安全、经济的数据" +
